...
export const Contact = () =>{
    return (
        <div class="contact" id="contact">
            ...
            <form action="mailto:bolarinwamartins79@gmail.com" encType='text/plain' method="post">
                <input type="text" name="name" id="" placeholder='username'/>
                 ...
                 <br/><select name="type of website" id="">
                 ...
                 <input type="datetime" name="" id="" placeholder='date'/>
